...
var __vueify_style__ = require("vueify-insert-css").insert("body{color:#404040}.jumbotron-top{color:#fff;background:#4cc3d9;margin-bottom:0}.btn-custom{color:#fff;background:#f16745}.jumbotron.jumbotron-green{padding:75px 0}#v-select .dropdown-toggle{background:#fff}#v-select .dropdown-toggle:after{color:#404040}#v-select .selected-tag{color:#147688;background-color:#d7f3f9;border-color:#91ddec}#v-select.dropdown.open .dropdown-menu,#v-select.dropdown.open .dropdown-toggle{border-color:#4cc3d9}#v-select .active a{background:rgba(50,50,50,.1);color:#333}#v-select.dropdown .highlight a,#v-select.dropdown li:hover a{background:#4cc3d9;color:#fff}#output{height:200px;border:none;color:#404040}")
'use strict';
...
var _Select = require('./components/Select.vue');
...
_vue2.default.transition('fadeInDownBig', {
    enterClass: 'fadeInDownBig',
    leaveClass: 'fadeOutDownBig'
});

_vue2.default.transition('slideInDown', {
    enterClass: 'slideInDown',
    leaveClass: 'slideOutDown'
});

_vue2.default.transition('slideUp', {
...
_vue2.default.transition('flipX', {
    enterClass: 'flipInX',
    leaveClass: 'flipOutX'
});

_vue2.default.transition('flipY', {
    enterClass: 'flipInY',
    leaveClass: 'flipOutY'
});

_vue2.default.transition('rotate', {
    enterClass: 'rotateIn',
...
},{"./App.vue":35,"vue":33}],39:[function(require,module,exports){
"use strict";
