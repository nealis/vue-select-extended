...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "<div class=dropdown :class=\"{open: open, }\" _v-3d450ab6=\"\"><div v-el:toggle=\"\" @click=toggleDropdown class=\"btn dropdown-toggle clearfix\" type=button _v-3d450ab6=\"\"><span class=form-control v-if=\"! searchable &amp;&amp; placeholder &amp;&amp; isValueEmpty\" _v-3d450ab6=\"\">{{ placeholder }}</span> <span class=\"alert alert-info\" v-for=\"option in valueAsArray\" _v-3d450ab6=\"\">{{ getOptionLabel(option) }} <button v-if=multiple @click=select(option) type=button class=close _v-3d450ab6=\"\"><span aria-hidden=true _v-3d450ab6=\"\">×</span></button></span> <input v-el:search=\"\" v-show=searchable v-model=search @keydown.delete=maybeDeleteValue @keydown.esc=onEscape @keydown.up.prevent=typeAheadUp @keydown.down.prevent=typeAheadDown @keydown.enter.prevent=typeAheadSelect @focus=\"open = true\" @blur=\"open = false\" type=search class=form-control :placeholder=searchPlaceholder _v-3d450ab6=\"\"></div><ul v-show=open :transition=transition :style=\"{ 'max-height': maxHeight }\" class=\"dropdown-menu animated\" _v-3d450ab6=\"\"><li v-for=\"option in filteredOptions\" :class=\"{ active: isOptionSelected(option), highlight: $index === typeAheadPointer }\" @mouseover=\"typeAheadPointer = $index\" _v-3d450ab6=\"\"><a @mousedown.prevent=select(option) _v-3d450ab6=\"\">{{ getOptionLabel(option) }}</a><li transition=fade v-if=!filteredOptions.length class=divider _v-3d450ab6=\"\"><li transition=fade v-if=!filteredOptions.length class=text-center _v-3d450ab6=\"\">Sorry, no matching options.</ul></div>"
